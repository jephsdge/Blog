$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '网站链接', name: 'linkBody', index: 'linkBody', width: 120},
            {label: '网站描述', name: 'linkDescription', index: 'linkDescription', width: 120},
            {label: '网站类型', name: 'linkType', index: 'linkType', width: 30, formatter: linkType},
